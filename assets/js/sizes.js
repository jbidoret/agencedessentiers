...
//           const doesParsedSizeMatchElementWidth = Math.ceil(parseFloat(parsedSize)) === elementWidth;
//           console.log({ currentSrcWidth, elementWidth, parsedSize, doesParsedSizeMatchElementWidth })
//       }
//       log();
...
//   // Whilst we debug image sizes, we want to ignore scroll bars as may not be accounted for in our
//   // `sizes` attribute.
//   document.body.style.overflow = 'hidden';
//   observe(document.querySelector('img'))
